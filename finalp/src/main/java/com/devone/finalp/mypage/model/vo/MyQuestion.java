...
public class MyQuestion implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7640488189512952301L;
	...
	public MyQuestion(int question_id, String question_category_id, String receive_member_id, String send_member_id,
	...
	public String toString() {
		return "MyQuestion [question_id=" + question_id + ", question_category_id=" + question_category_id
