...
DROP TABLE MEMBER_ACCOUNT CASCADE CONSTRAINTS;
 ...
 CREATE TABLE MEMBER_ACCOUNT (	
   ...
   COMMENT ON COLUMN MEMBER_ACCOUNT.BANK_NAME IS '은행명';
...
DROP TABLE PROJECT CASCADE CONSTRAINTS;
 ...
 CREATE TABLE PROJECT (	
	...
	MEMBER_ID VARCHAR2(30), 
	IMAGE_ORINAME VARCHAR2(100), 
    IMAGE_RENAME VARCHAR2(100), 
    ...
    END_DATE DATE,
    PAYMENT_DATE DATE,
    REFUND_ROLE VARCHAR2(300),
    PROJECT_ONOFF_FLAG VARCHAR2(1),
    REPORT_COUNT NUMBER,
...
DROP TABLE PRODUCT CASCADE CONSTRAINTS;
 ...
 CREATE TABLE PRODUCT (	
   ...
   COMMENT ON COLUMN PRODUCT.CAPACITY IS '최대 수량';
...
DROP TABLE PROJECT_ACCOUNT CASCADE CONSTRAINTS;
 ...
 CREATE TABLE PROJECT_ACCOUNT (	
   ...
   COMMENT ON COLUMN PROJECT_ACCOUNT.BANK_NAME IS '거래 은행';
...
DROP TABLE PAYMENT CASCADE CONSTRAINTS;
 ...
 CREATE TABLE PAYMENT (	
   ...
   COMMENT ON COLUMN PAYMENT.GIFT_ID IS '선물 아이디';
   COMMENT ON COLUMN PAYMENT.PRODUCT_ID IS '공동구매 물품 아이디';
   COMMENT ON COLUMN PAYMENT.TOTAL_AMOUNT IS '총 금액';
   COMMENT ON COLUMN PAYMENT.TOTAL_COUNT IS '구매 수량';
...
DROP TABLE BOARD CASCADE CONSTRAINTS;
 ...
 CREATE TABLE BOARD (	
   ...
   COMMENT ON COLUMN BOARD.RE_FULENAME IS '파일 변경된 이름';
